...
func (r *Route) Resolve(waker *sleep.Waker) (<-chan struct{}, *tcpip.Error) {
	...
	entry, ch, err := r.ref.neigh.entry(nextAddr, r.LocalAddress, r.ref.linkRes, waker)
	if err != nil {
		return ch, err
	}
...
func (r *Route) RemoveWaker(waker *sleep.Waker) {
	...
	r.ref.neigh.removeWaker(nextAddr, waker)
}

// IsResolutionRequired returns true if Resolve() must be called to resolve
// the link address before the this route can be written to.
func (r *Route) IsResolutionRequired() bool {
	return r.ref.isValidForOutgoing() && r.ref.neigh != nil && r.RemoteLinkAddress == ""
}
